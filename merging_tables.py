...
target_csv_path = r"C:\Users\user\PycharmProjects\EDA\backup_2024-12-01\merged_events.csv"

whoscored_events_csv_path = r"C:\Users\user\PycharmProjects\EDA\backup_2024-12-01\whoscored_events.csv"

fixtures_csv_path = r"C:\Users\user\PycharmProjects\EDA\backup_2024-12-01\fixtures.csv"

whoscored_possession_json_path = r"C:\Users\user\Desktop\jsons\updated_possession_data.json"
...
if __name__ == "__main__":
    league_id = 39
    season_FootballAPI = 2020
    league_name = "ENG-Premier League"
    season_WhoScored = str(season_FootballAPI) + "-" + str(season_FootballAPI+1)
    games_id_dict = mapping_games_footballapi_whoscoredapi(league_id, season_FootballAPI, league_name, season_WhoScored)
